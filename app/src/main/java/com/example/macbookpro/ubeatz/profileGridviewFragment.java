...
public class profileGridviewFragment extends Fragment {
    private GridView gv;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_profile_gridview, container, false);

        gv=(GridView) view.findViewById(R.id.gridView);
//        gv.setAdapter(new profileGridViewAdapter(getActivity()));
