...
public class findboxAdapter extends ArrayAdapter<Location> {
    ...
    public findboxAdapter(Context context, int textViewResourceId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (row == null) {
            ...
            row = inflater.inflate(R.layout.layout_custom_findbox_listview, parent, false);
