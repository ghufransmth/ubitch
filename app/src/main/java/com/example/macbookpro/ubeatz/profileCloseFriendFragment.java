...
import com.example.macbookpro.ubeatz.adapter.profileCloseFriendAdapter;
...
public class profileCloseFriendFragment extends Fragment {
    private GridView gv;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_profile_close_friend, container, false);

        gv=(GridView) view.findViewById(R.id.gridView);
//        gv.setAdapter(new profileCloseFriendAdapter(getActivity()));
